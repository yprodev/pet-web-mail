...
- [x] Set up the project with Create React App tool
- [x] Check the .tsconfig file rules
- [ ] Set up the JSON static web-server with the data

## Prerequisites

- Go to the `https://github.com/yprodev/pet-web-mail-server` and clone the repository.
- Go through the `README.md` file to start the server.
